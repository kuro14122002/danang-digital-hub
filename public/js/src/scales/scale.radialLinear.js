...
import {
  ...
  renderText,
  _isPointInArea,
} from "../helpers/helpers.canvas.js";
import {
  HALF_PI,
  TAU,
  toDegrees,
...
import {
  ...
  toPadding,
  toTRBLCorners,
} from "../helpers/helpers.options.js";
...
function isNotOverlapped(item, area) {
  ...
  const apexesInArea =
    ...
    _isPointInArea({ x: left, y: bottom }, area) ||
    _isPointInArea({ x: right, y: top }, area) ||
    _isPointInArea({ x: right, y: bottom }, area);
  return !apexesInArea;
}
